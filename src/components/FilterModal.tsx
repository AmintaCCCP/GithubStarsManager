        ...
        <div>
          ...
          <div className="flex space-x-2 mb-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-brand-indigo text-white rounded-lg hover:bg-blue-700 dark:bg-brand-indigo/80 dark:hover:bg-brand-indigo disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-1 transition-colors"
            >
