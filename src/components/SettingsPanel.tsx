...
const MobileTabNav: React.FC<MobileTabNavProps> = ({ tabs, activeTab, onTabChange }) => {
  ...
  return (
    <div 
      className="relative w-full border-b border-gray-200 dark:border-white/8 bg-gray-50/95 dark:bg-panel-dark/95 backdrop-blur-sm"
    >
      {/* 滚动容器 */}
      <div
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`
              ...
              ${activeTab === tab.id
                ? 'text-blue-600 dark:text-brand-violet'
                : 'text-gray-600 dark:text-text-tertiary hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/10/50'
              }
            `}
            style={{
    ...
    return (
      ...
      >
        <div className="w-full max-w-5xl h-[85vh] bg-white dark:bg-panel-dark rounded-2xl shadow-2xl overflow-hidden flex flex-col">
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-white/8 bg-gray-50 dark:bg-panel-dark">
            <div className="flex items-center space-x-3">
              <Settings className="w-6 h-6 text-blue-600 dark:text-brand-violet" />
          ...
          <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
            {/* 侧边栏 - 桌面端 */}
            <div className="hidden md:block w-64 border-r border-gray-200 dark:border-white/8 bg-gray-50 dark:bg-panel-dark overflow-y-auto">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors text-left ${
                      activeTab === tab.id
                        ...
                        : 'text-gray-700 dark:text-text-secondary hover:bg-gray-200 dark:hover:bg-white/10'
                    }`}
                  >
                    {tab.icon}
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="hidden lg:block w-64 flex-shrink-0 lg:sticky lg:top-4 lg:self-start">
          <div className="bg-white dark:bg-panel-dark rounded-xl border border-gray-200 dark:border-white/8 overflow-hidden">
        ...
        <div className="flex-1 min-w-0">
          <div className="bg-white dark:bg-panel-dark rounded-xl border border-gray-200 dark:border-white/8 p-4 sm:p-6">
            {renderTabContent()}
          </div>
        </div>
      </div>
