...
export const SubscriptionRepoCard: React.FC<SubscriptionRepoCardProps> = ({ repo, onStar, onAnalyze, desktopSafeMode = false }) => {
  ...
  const rankBadgeClass = useMemo(() => {
    ...
    return 'bg-gray-100 text-gray-600 dark:bg-white/[0.04] dark:text-text-secondary';
  }, [repo.rank]);
  ...
  return (
    ...
    <div 
      ...
      className={`bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/8 p-5 transition-all duration-200 ${
        desktopSafeMode
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between gap-3 mb-2">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <a
                ...
                className="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 text-gray-500 dark:bg-white/[0.04] dark:text-text-tertiary hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
              ...
              <button
                ...
                className={`flex items-center justify-center w-8 h-8 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                  isStarred
                    ...
                    : 'bg-gray-100 text-gray-500 dark:bg-white/[0.04] dark:text-text-tertiary hover:bg-yellow-100 hover:text-yellow-600 dark:hover:bg-yellow-900 dark:hover:text-yellow-400'
                }`}
          ...
          {/* Description */}
          {repo.description && (
            <p className="text-sm text-gray-600 dark:text-text-tertiary mb-3 line-clamp-2">
              {repo.description}
            </p>
          )}
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-3 justify-end">
          <button
            ...
            className="px-4 py-2 rounded-lg text-sm font-medium text-gray-600 dark:text-text-tertiary hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
          >
            {t('取消', 'Cancel')}
          </button>
          <button
