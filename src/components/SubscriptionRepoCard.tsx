          ...
          <div className="flex items-start justify-between gap-3 mb-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
              ...
              <button
                ...
                className="hidden sm:flex items-center justify-center w-8 h-8 rounded-lg bg-indigo-100 text-indigo-600 dark:bg-indigo-900 dark:text-indigo-400 hover:bg-indigo-200 dark:hover:bg-indigo-800 transition-colors"
              ...
              <a
                ...
                className="hidden sm:flex items-center justify-center w-8 h-8 rounded-lg bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
