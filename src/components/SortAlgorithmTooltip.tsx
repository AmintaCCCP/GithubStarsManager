    ...
    <div className="relative inline-flex items-center">
      ...
      {isVisible && (
        <div className="absolute top-full mt-2 left-0 sm:left-1/2 sm:-translate-x-1/2 z-[9999]" style={{ zIndex: 9999 }}>
          <div className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl p-4 w-[calc(100vw-2rem)] sm:w-80 max-w-[calc(100vw-2rem)]">
            {/* Arrow */}
