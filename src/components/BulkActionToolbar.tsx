    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          className="h-11 w-11 shrink-0 rounded-lg bg-muted text-muted-foreground hover:bg-accent hover:text-foreground sm:h-10 sm:w-10"
        >
...
export const BulkActionToolbar: React.FC<BulkActionToolbarProps> = ({
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 max-w-full bg-card dark:bg-card border-t border-border dark:border-border pb-[calc(0.75rem+env(safe-area-inset-bottom))] shadow-lg z-50 ${
    ...
    >
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-3 sm:py-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
          {/* Selection Info */}
          <div className="flex flex-wrap items-center justify-between gap-2 sm:justify-start sm:space-x-4">
            ...
            <div className="flex flex-wrap items-center gap-1 sm:space-x-2">
              <Button
                ...
                className="flex min-h-11 min-w-11 items-center space-x-1 px-2 py-1.5 text-xs text-muted-foreground transition-colors hover:bg-muted sm:min-h-0 sm:min-w-0 sm:px-3 sm:text-sm dark:text-muted-foreground dark:hover:bg-accent rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          {/* Action Buttons */}
          <div data-testid="bulk-action-strip" className="flex w-full max-w-full items-center justify-between space-x-1 overflow-x-auto touch-pan-x pb-1 sm:justify-start sm:space-x-2 sm:pb-0 -mx-2 px-2 sm:mx-0 sm:px-0 [&>button]:min-h-11 [&>button]:min-w-11 sm:[&>button]:h-10 sm:[&>button]:w-10">
            <Button
              type="button"
              variant="ghost"
              size="icon"
              ...
              disabled={isProcessing}
              className={`min-h-11 min-w-11 flex-shrink-0 flex items-center justify-center w-9 h-9 sm:min-h-0 sm:min-w-0 sm:w-10 sm:h-10 p-0 rounded-lg transition-colors ${
                showConfirm === 'unstar'
            ...
            <Button
              ...
              className="min-h-11 min-w-11 flex-shrink-0 p-2 text-muted-foreground dark:text-muted-foreground hover:bg-muted dark:hover:bg-accent rounded-lg transition-colors disabled:opacity-50 sm:min-h-0 sm:min-w-0"
