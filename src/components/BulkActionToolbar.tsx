        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0">
          ...
          <div className="flex items-center justify-between sm:justify-start space-x-2 sm:space-x-4">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              <button
                onClick={onSelectAll}
                className="flex items-center space-x-1 px-2 sm:px-3 py-1.5 text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
