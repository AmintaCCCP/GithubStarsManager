...
export const ListsPushIndicator: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] w-80 max-w-[calc(100vw-2rem)] bg-white dark:bg-card rounded-xl border border-border dark:border-border shadow-lg p-4">
