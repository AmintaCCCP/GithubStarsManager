...
export const UpdateNotificationBanner: React.FC = () => {
  ...
  return (
    <div className="bg-blue-50 dark:bg-brand-indigo/20/20 border-b border-blue-200 dark:border-blue-800">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="flex items-center space-x-1 px-3 py-1.5 bg-brand-indigo text-white text-xs rounded-md hover:bg-blue-700 transition-colors"
            >
            ...
            <button
              ...
              className="p-1.5 text-brand-violet dark:text-brand-violet hover:bg-brand-indigo/20 dark:hover:bg-blue-800 rounded-md transition-colors"
              title={t('关闭', 'Close')}
            >
              <X className="w-4 h-4" />
            </button>
