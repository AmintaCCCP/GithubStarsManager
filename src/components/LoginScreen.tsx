  ...
  return (
    <div className={`min-h-screen ${theme === 'light' ? 'bg-gradient-to-br from-blue-50 to-indigo-100' : 'bg-gradient-to-br from-gray-900 to-gray-800'} flex items-center justify-center p-4 transition-colors duration-300`}>
      ...
      <div className="fixed top-4 right-4 flex items-center gap-2 z-50">
        {/* Language Toggle */}
        <div className="flex items-center bg-white dark:bg-panel-dark rounded-lg shadow-md border border-gray-200 dark:border-white/8 overflow-hidden">
          <button
            onClick={() => setLanguage('zh')}
            className={`px-3 py-2 text-sm font-medium transition-colors ${language === 'zh' ? 'bg-blue-600 text-white' : 'text-gray-600 dark:text-text-secondary hover:bg-gray-100 dark:hover:bg-white/10'}`}
          >
            中文
          </button>
          <button
            onClick={() => setLanguage('en')}
            className={`px-3 py-2 text-sm font-medium transition-colors ${language === 'en' ? 'bg-blue-600 text-white' : 'text-gray-600 dark:text-text-secondary hover:bg-gray-100 dark:hover:bg-white/10'}`}
          >
            EN
          </button>
        </div>
        ...
        <button
          ...
          className="p-2 rounded-lg bg-white dark:bg-panel-dark shadow-md border border-gray-200 dark:border-white/8 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-panel-dark rounded-2xl shadow-xl border border-gray-200 dark:border-white/8 p-8">
          <div className="text-center mb-6">
            <Github className="w-10 h-10 text-gray-700 dark:text-text-secondary mx-auto mb-3" />
            <h2 className="text-xl font-semibold text-gray-900 dark:text-text-primary mb-2">
              {t('连接GitHub', 'Connect with GitHub')}
            </h2>
            <p className="text-gray-600 dark:text-text-tertiary text-sm">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={isLoading}
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-white/8 rounded-lg focus:ring-2 focus:ring-brand-violet focus:border-transparent bg-white dark:bg-white/[0.04] text-gray-900 dark:text-text-primary disabled:bg-gray-50 dark:disabled:bg-gray-600 disabled:text-gray-500 dark:disabled:text-gray-400"
                />
              </div>
            </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 dark:bg-white/[0.04]/50 rounded-lg">
            ...
            <ol className="text-xs text-gray-600 dark:text-text-tertiary space-y-1">
            ...
            <div className="mt-3">
              <a
                ...
                className="text-blue-600 hover:text-blue-700 dark:text-brand-violet dark:hover:text-blue-300 text-sm font-medium hover:underline"
              >
