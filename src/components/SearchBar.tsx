...
export const SearchBar: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-panel-dark rounded-xl border border-gray-200 dark:border-white/8 p-4 sm:p-6 mb-6">
      {/* Search Input */}
      <div className="relative mb-4">
        ...
        <input
          ...
          className="w-full pl-10 pr-24 sm:pr-40 py-3 border border-gray-300 dark:border-white/8 rounded-lg focus:ring-2 focus:ring-brand-violet focus:border-transparent bg-white dark:bg-white/[0.04] text-gray-900 dark:text-text-primary placeholder-gray-500 dark:placeholder-gray-400"
        />

        {/* Search History Dropdown */}
        {showSearchHistory && searchHistory.length > 0 && (
          <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/8 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto">
            <div className="p-2 border-b border-gray-100 dark:border-white/8 flex items-center justify-between">
            ...
            {searchHistory.map((historyQuery, index) => (
              <button
                ...
                className="w-full px-3 py-2 text-left text-sm text-gray-700 dark:text-text-secondary hover:bg-gray-50 dark:hover:bg-white/10 transition-colors flex items-center space-x-2"
              >
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          {activeFiltersCount > 0 && (
            <button
              ...
              className="flex items-center space-x-1 px-3 py-2 text-sm text-gray-600 dark:text-text-tertiary hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
            >
              <X className="w-4 h-4" />
        ...
        <div className="flex items-center gap-2 overflow-x-auto">
          <select
            ...
            className="px-3 py-2 border border-gray-300 dark:border-white/8 rounded-lg bg-white dark:bg-white/[0.04] text-gray-900 dark:text-text-primary text-sm"
          >
          ...
          <button
            ...
            className="px-3 py-2 border border-gray-300 dark:border-white/8 rounded-lg bg-white dark:bg-white/[0.04] text-gray-900 dark:text-text-primary text-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
          >
      ...
      {/* Advanced Filters */}
      {showFilters && (
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-white/8 space-y-6">
          {/* Status Filters */}
          <div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:space-x-4 sm:gap-4">
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className="w-24 px-3 py-1.5 border border-gray-300 dark:border-white/8 rounded-lg bg-white dark:bg-white/[0.04] text-gray-900 dark:text-text-primary text-sm"
                />
              </div>
              <div className="flex items-center space-x-2">
                <label className="text-sm text-gray-600 dark:text-text-tertiary">
