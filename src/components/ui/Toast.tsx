  ...
  return (
    <ToastPrimitive.Provider swipeDirection="right">
      <ToastPrimitive.Root
        ...
        className={cn('fixed right-4 top-4 z-[100] flex w-[min(420px,calc(100vw-2rem))] items-center gap-3 rounded-lg border px-4 py-3 shadow-lg outline-none data-[state=closed]:animate-fade-out data-[state=open]:animate-fade-in', className)}
      >
