    ...
    expect(buildReleaseDownloadLinks(release)).toEqual([
      {
        ...
        authenticatedPath: '/repos/owner/repo/releases/assets/7',
        size: 1024,
        isSourceCode: false,
        assetId: 7,
      },
      {
        ...
        authenticatedPath: '/repos/owner/repo/zipball/v1.2.0',
        size: null,
        isSourceCode: true,
      },
      {
        ...
        authenticatedPath: '/repos/owner/repo/tarball/v1.2.0',
        size: null,
        isSourceCode: true,
      },
    ]);
