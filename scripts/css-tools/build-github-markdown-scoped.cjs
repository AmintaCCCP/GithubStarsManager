...
/* GitHub's vendored rules consume four Primer color-role custom properties
   that github-markdown-css never declares (it assumes the host page ships
   them). Define them per theme so focus outlines, kbd borders and .pl-ii
   danger highlights resolve; values mirror @primer/primitives functional
   themes for this package version. */
.markdown-body {
