...
- `v0.8.3` — the exact release tag; it must match the root `package.json` client version
- `0.8.3`, `0.8`, `0` — convenience semver tags derived from the same `v0.8.3` release
...
```bash
# Set this to 0.8.3 for a version-pinned deployment, or latest for main.
