...
| `npm run build` | 通过；legacy 入口 2,783.20 kB；独立 checker 实测 2,717.97 KiB，低于 3,000 KiB hard budget，无 chunk warning |
| `git diff --check` | 通过 |
